                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <div
                                ...
                                style={{
                                    background: "linear-gradient(to top, hsl(var(--bio-card)) 40%, transparent)",
                                }}
                            >
                                <h1
                        ...
                        <div className="px-5 md:px-8 pb-12 pt-4 flex flex-col gap-4">
                            {products.map((product, i) => (
                                <motion.a
                                    ...
                                    className="flex gap-4 items-center rounded-xl overflow-hidden group cursor-pointer"
                                    style={{
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0 py-4 pr-4">
                                        <p
                                            className="text-sm md:text-base font-serif font-semibold leading-snug line-clamp-2 mb-2"
                                            style={{ color: "hsl(var(--bio-card-foreground))" }}
                                        >
                                            {product.title}
                                        </p>
